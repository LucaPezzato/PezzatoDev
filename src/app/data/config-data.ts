...
export const CONFIG_FILES: ConfigFile[] = [
  ...
  },
  {
    ...
    "content": "* {\n    border: none;\n    border-radius: 0;\n    font-family: \"JetBrains mono\";\n    font-size: 14px;\n    min-height: 0;\n}\n\nwindow#waybar {\n\t/* background: #282a36; */\n\tcolor:#f8f8f2;\n  background: transparent;\n\t/*#border-bottom: 2px solid #bd93f9;*/\n}\n\n#clock, #battery, #cpu, #memory, #network, #pulseaudio, #tray, #bluetooth, #backlight,#workspaces{\n    padding: 0px 12px;\n    margin: 4px; \n    border-radius: 8px;\n\t  background: #282a36;\n\t  border: 2px solid #bd93f9;\n}\n#workspaces {\n    padding: 0;\n}\n\n#network, #battery, #cpu, #memory, #network, #pulseaudio, #tray, #bluetooth, #backlight{\n    /*border-right: 1px solid #bd93f9;*/\n\t background: #282a36;\n}\n#clock {\n    font-weight: bold;\n}\n\n\n#battery.warning {\n    color: #ffb86c;\n    background: transparent;\n}\n\n#battery.critical{\n\tcolor: #ff5555;\n  background: transparent;\n}\n\n@keyframes blink {\n    to {\n        background-color: #ffffff;\n        color: black;\n    }\n}\n\n#battery.charging{\n    color: #50fa7b;\n    background-color: transparent;\n}\n\n#network.disconnected {\n    background: #f53c3c;\n}\n\n#window{\n\tcolor:  #bd93f9;\n\tfont-weight: bold;\n\tpadding: 0 20px;\n}\n\n#workspaces button.active{\n\tbackground:  #bd93f9;\n}\n"
  },
  {
    "id": "kitty_kitty_conf",
...
export const PACKAGE_GROUPS: PackageGroup[] = [
  {
    ...
    "icon": "layout",
    "description": "Hyprland compositor, Ly TUI display manager, status bar, screen locker, app launcher & Wayland utilities.",
    "installCommand": "yay -S --needed ly hyprland hyprlock hyprpaper hyprpolkitagent hyprshot waybar-git fuzzel dunst xdg-desktop-portal-hyprland-git clipse waypaper aquamarine hyprcursor hyprgraphics wl-clipboard",
    "packages": [
      {
        "name": "ly",
...
export const FULL_INSTALL_COMMAND = `yay -S --needed \
  hyprland hyprlock hyprpaper hyprpolkitagent hyprshot waybar-git fuzzel dunst clipse waypaper \
